...
int main(int argc, char* argv[])
{
  ...
  auto total1 = std::chrono::duration_cast<std::chrono::seconds>(stop1 - start1).count();


  // Plaintext prime modulus
  unsigned long p = 131;
  // Cyclotomic polynomial - defines phi(m)
  unsigned long m = 440; // this will give 48 slots
  argc = 1;
  //delete argv[1];
  ...
  string temp_file = argv[1];
  std::string db_filename = "/home/xian/HoTEE0/5/HElib/kv"+temp_file+".csv";
  ...
  auto total12 = std::chrono::duration_cast<std::chrono::nanoseconds>(stop12 - start12).count();
  cout << "Key Switch:" << total12 << endl;
  ...
  total1 = std::chrono::duration_cast<std::chrono::seconds>(stop1 - start1).count();
  double total = std::chrono::duration_cast<std::chrono::microseconds>(stop - start).count();
  std::cout << "->->->!!!!!! EncryptDatabase seconds: " << total1 << std::endl;
  ...
  std::string query_string = "aaaaaajg";
  ...
  stop1 = std::chrono::steady_clock::now();
  total1 = std::chrono::duration_cast<std::chrono::seconds>(stop1 - start1).count();
  std::cout << "->->->!!!!!! Search seconds: " << total1 << std::endl;
  ...
  auto total11 = std::chrono::duration_cast<std::chrono::nanoseconds>(stop11 - start11).count();
  std::cout << "->->->!!!!!! Decrypt seconds: " << total11 << std::endl;
